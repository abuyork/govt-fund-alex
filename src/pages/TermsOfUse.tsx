      ...
      <main className="flex-grow container mx-auto px-6 py-12 space-y-10">
        ...
        <section className="max-w-4xl space-y-4">
          ...
          <p className="text-gray-700">
            1. 본 약관은 크리피 솔루션즈가 운영하는 온라인 쇼핑몰 '기발자들 AI 정부지원사업 보조서비스 (https://kvzd.info)'에서 제공하는 서비스(이하 '서비스'라 합니다)를 이용함에 있어 당사자의 권리 의무 및 책임사항을 규정하는 것을 목적으로 합니다.
          </p>
          <p className="text-gray-700">
        ...
        <section className="max-w-4xl space-y-4">
          ...
          <p className="text-gray-700">
            1. '회사'라 함은, '크리피 솔루션즈'가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 운영하는 사업자를 말하며, 아울러 '기발자들 AI 정부지원사업 보조서비스(https://kvzd.info)'을 통해 제공되는 전자상거래 관련 서비스의 의미로도 사용합니다.
          </p>
          <p className="text-gray-700">
        ...
        {/* Continue with more sections for the remaining articles... */}
        {/* ───────────────────────── 제4조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제4조(약관의 명시 및 개정)</h2>
          <p className="text-gray-700">
            1. '회사'는 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지, 전화번호, 모사전송번호(FAX), 전자우편주소, 사업자등록번호, 통신판매업신고번호 등을 이용자가 쉽게 알 수 있도록 '회사' 홈페이지의 초기 서비스 화면에 게시합니다. 다만 본 약관의 내용은 이용자가 연결화면을 통하여 확인할 수 있도록 할 수 있습니다.
          </p>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제5조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제5조(제공하는 서비스)</h2>
          <p className="text-gray-700">
            '회사'는 다음의 서비스를 제공합니다.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <li>결제대금 보호서비스, 이용자 문의서비스, 상품 구매평 등 기타 정보 제공</li>
            <li>직접 또는 제휴사와 공동으로 제공하는 이벤트 등</li>
        ...
        {/* ───────────────────────── 제6조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제6조(서비스의 중단 등)</h2>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제7조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제7조(회원가입)</h2>
          <p className="text-gray-700">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>가. 가입신청자가 본 약관에 따라 회원자격을 상실한 적이 있는 경우. 다만, '회사'의 재가입 승낙을 얻은 경우에는 예외로 합니다.</li>
            <li>나. 회원정보에 허위, 기재누락, 오기 등 불완전한 부분이 있는 경우</li>
            <li>다. 기타 회원으로 등록하는 것이 '회사'의 운영에 현저한 지장을 초래하는 것으로 인정되는 경우</li>
          </ul>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제8조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제8조(회원탈퇴 및 자격상실 등)</h2>
          <p className="text-gray-700">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>가. 회원가입 시 허위정보를 기재한 경우</li>
            <li>나. 다른 이용자의 정상적인 이용을 방해하는 경우</li>
            <li>다. 관계법령 또는 본 약관에서 금지하는 행위를 한 경우</li>
            <li>라. 공서양속에 어긋나는 행위를 한 경우</li>
            <li>마. 기타 '회원'으로 등록하는 것이 적절하지 않은 것으로 판단되는 경우</li>
          </ul>
        </section>

        {/* ───────────────────────── 제9조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제9조(회원에 대한 통지)</h2>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제10조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제10조(구매신청)</h2>
          <p className="text-gray-700">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <li>3. 약관내용, 청약철회가 제한되는 서비스, 배송료 등 비용부담과 관련된 내용에 대한 확인 및 동의 표시</li>
        ...
        {/* ───────────────────────── 제11조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제11조(계약의 성립)</h2>
          <p className="text-gray-700">
            1. '회사'는 다음 각호의 사유가 있는 경우 본 약관의 '구매신청' 조항에 따른 구매신청을 승낙하지 않을 수 있습니다.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>가. 신청 내용에 허위, 누락, 오기가 있는 경우</li>
            <li>나. 회원자격이 제한 또는 정지된 고객이 구매를 신청한 경우</li>
            <li>다. 재판매, 기타 부정한 방법이나 목적으로 구매를 신청하였음이 인정되는 경우</li>
            <li>라. 기타 구매신청을 승낙하는 것이 '회사'의 기술상 현저한 지장을 초래하는 것으로 인정되는 경우</li>
          </ul>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제12조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제12조(결제방법 및 일반회원의 이용 수수료)</h2>
          <p className="text-gray-700">
            1. '회사'의 '사이트'에서 구매한 상품에 대한 대금은 다음 각호의 방법으로 결제할 수 있습니다.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>가. 폰뱅킹, 인터넷뱅킹 등 각종 계좌이체</li>
            <li>나. 선불카드, 직불카드, 신용카드 등 각종 카드결제</li>
            <li>다. ARS, 휴대전화등을 이용한 결제</li>
          </ul>
          <p className="text-gray-700">
            2. '회사'는 '구매자'가 결제수단에 대한 정당한 사용권한을 가지고 있는지 여부를 확인할 수 있으며, 이에 대한 확인이 완료될 때까지 거래 진행을 중지하거나, 확인이 불가능한 거래를 취소할 수 있습니다.
          </p>
          <p className="text-gray-700">
            3. '회사'의 정책 및 결제업체(이동통신사, 카드회사 등) 또는 결제대행업체(PG)의 기준에 따라 '구매자' 당월 누적 결제액 및 충전한도가 제한될 수 있습니다.
          </p>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제13조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제13조(수신확인통지, 구매신청 변경 및 취소)</h2>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제14조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제14조(재화 등의 공급)</h2>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제15조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제15조(환급)</h2>
          <p className="text-gray-700">
            '회사'는 '구매자'가 신청한 '상품'이 품절, 생산중단 등의 사유로 인도 또는 제공할 수 없게된 경우 지체없이 그 사유를 '구매자'에게 통지합니다. 이 때 '구매자'가 재화 등의 대금을 지불한 경우 대금을 받은 날부터 3영업일 이내에 환급하거나 이에 필요한 조치를 취합니다.
          </p>
        </section>

        {/* ───────────────────────── 제16조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제16조(청약철회)</h2>
          <p className="text-gray-700">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>가. '구매자'에게 책임있는 사유로 재화 등이 멸실 또는 훼손된 경우(다만, 재화를 확인하기 위하여 포장 등을 훼손한 경우는 예외로 합니다)</li>
            <li>나. '구매자'의 사용 또는 소비에 의하여 재화의 가치가 현저히 감소한 경우</li>
            <li>다. 시간의 경과로 재판매가 곤란할 정도로 재화의 가치가 현저히 감소한 경우</li>
            <li>라. 같은 성능을 지닌 재화등으로 복제가 가능한 경우 그 원본이 되는 재화의 포장을 훼손한 경우</li>
            <li>마. '구매자'의 주문에 의하여 개별적으로 생산한 상품으로서 청약철회 및 교환의 제한에 대하여 사전에 고지한 경우</li>
          </ul>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제17조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제17조(청약철회의 효과)</h2>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제18조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제18조(개인정보보호)</h2>
          <p className="text-gray-700">
            1. '회사'는 '구매자'의 정보수집시 다음의 필수사항 등 구매계약 이행에 필요한 최소한의 정보만을 수집합니다.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>가. 성명</li>
            <li>나. 주민등록번호 또는 외국인등록번호</li>
            <li>다. 주소</li>
            <li>라. 전화번호(또는 이동전화번호)</li>
            <li>마. 아이디(ID)</li>
            <li>바. 비밀번호</li>
            <li>사. 전자우편(e-mail)주소</li>
          </ul>
          <p className="text-gray-700">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>가. 배송업무상 배송업체에게 배송에 필요한 최소한의 정보(성명, 주소, 전화번호)를 제공하는 경우</li>
            <li>나. 통계작성, 학술연구 또는 시장조사를 위하여 필요한 경우로서 특정 개인을 식별할 수 없는 형태로 제공하는 경우</li>
            <li>다. 재화 등의 거래에 따른 대금정산을 위하여 필요한 경우</li>
            <li>라. 도용방지를 위하여 본인 확인이 필요한 경우</li>
            <li>마. 관계법령의 규정에 따른 경우</li>
          </ul>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제19조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제19조('회사'의 의무)</h2>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제20조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제20조(이용자 및 회원의 의무)</h2>
          <p className="text-gray-700">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>가. '회사'에 게시된 정보의 변경</li>
            <li>나. '회사'가 정한 정보 외의 다른 정보의 송신 또는 게시</li>
            <li>다. '회사' 및 제3자의 저작권 등 지식재산권에 대한 침해</li>
            <li>라. '회사' 및 제3자의 명예를 훼손하거나 업무를 방해하는 행위</li>
            <li>마. 외설 또는 폭력적인 메시지, 화상, 음성 기타 관계법령 및 공서양속에 반하는 정보를 '회사'의 '사이트'에 공개 또는 게시하는 행위</li>
          </ul>
          <p className="text-gray-700">
        ...
        {/* ───────────────────────── 제21조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4">
          <h2 className="text-xl font-semibold">제21조(저작권의 귀속 및 이용)</h2>
          <p className="text-gray-700">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>가. '회사'가 제공하는 서비스 내에서 '이용자'가 작성한 '콘텐츠'의 복제, 수정, 전시, 전송, 배포 등 저작권을 침해하지 않는 범위 내의 2차적 저작물 또는 편집 저작물 작성을 위한 사용. 다만 '이용자'가 해당 '콘텐츠'의 삭제 또는 사용중지를 요청하는 경우 관련법에 따라 보존해야하는 사항을 제외하고 관련 '콘텐츠'를 모두 삭제 또는 사용중지합니다.</li>
            <li>나. 서비스의 운영, 홍보, 서비스 개선 및 새로운 서비스 개발을 위한 범위내의 사용</li>
            <li>다. 미디어, 통신사 등을 통한 홍보목적으로 '콘텐츠'를 제공, 전시하도록 하는 등의 사용</li>
          </ul>
        </section>

        {/* ───────────────────────── 제22조 ───────────────────────── */}
        <section className="max-w-4xl space-y-4 pb-2">
          <h2 className="text-xl font-semibold">제22조(분쟁의 해결)</h2>
          <p className="text-gray-700">
        ...
        <section className="max-w-4xl space-y-4 pb-2">
          ...
          <p className="text-gray-700">
            제1조(시행일) 본 약관은 2025.05.01.부터 적용합니다.
          </p>
        </section>
      </main>
